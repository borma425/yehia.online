...
return OUTCLASS}else if(stream.match(delimiter)){state.tokenize=tokenOuter;return OUTCLASS}else if(stream.match('{{')){return OUTCLASS}else if(stream.match('{',!1)){state.tokenize=tokenNestedExpr(0)
